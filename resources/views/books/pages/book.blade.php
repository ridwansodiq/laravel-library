    ...
    <div id="write-review" class="col s12">
     ...
     <form method="POST" action="{{ route('review.create',['book'=>$book->id]) }}" >
                    ...
                    <div class="row">
                        ...
                        <input id="name" name="name" required type="text" value="{{old('name') ? old('name') : Auth::user()->name}}" class="validate disabled">
                        <label for="name">Name</label>
                        </div>
                        <div class="input-field col s6">
                        <input id="email" name="email" required type="email"  value="{{old('email') ? old('email') : Auth::user()->email}}" class="validate disabled">
